...
// AddShareForm imports the real shareAction from "../actions", a "use
// server" file that in turn reaches into @/lib/api and @/lib/session. Mock
// it the same way the actions.test.ts files do, so this stays a pure
...
mock.module("../actions", () => ({ shareAction }));
